        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link
                to="/"
                className="text-gray-800 hover:text-[#ad651c] transition-colors font-semibold text-sm"
              >
                Home
              </Link>
              <Link
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a
                href="https://www.linkedin.com/in/mohammad-siddique-sakib/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 bg-[#ffdb58] rounded-full flex items-center justify-center border-2 border-black hover:bg-[#f0b127] transition-all hover:scale-110"
                style={{ boxShadow: "3px 3px 0px 0px #000" }}
        ...
        <div className=" pt-2">
          <div className=" items-center gap-4">
            <p className=" text-gray-800 font-semibold text-sm text-center">
              © 2025 FailGuru. All rights reserved.
            </p>
          </div>
        </div>
      </div>
